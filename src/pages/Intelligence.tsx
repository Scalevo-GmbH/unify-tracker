...
const Intelligence = () => {
  ...
  return (
    <div className="container mx-auto py-8 px-4 md:px-6">
      ...
      <FadeInSection>
        <h3 className="text-2xl font-bold mb-6 text-center">{t('whatAiWillDo')}</h3>
      </FadeInSection>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">{t('connectDataDesc')}</p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">{t('aiAnalysisDesc')}</p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">{t('getRecommendationsDesc')}</p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-4">
            ...
            >
              <CollapsibleTrigger className="flex justify-between w-full p-4 text-left font-medium hover:bg-gray-50">
                <span>{t('faqReleaseQuestion')}</span>
                <span>{isOpen ? '−' : '+'}</span>
              </CollapsibleTrigger>
            ...
            <Collapsible className="border border-gray-200 rounded-md overflow-hidden">
              <CollapsibleTrigger className="flex justify-between w-full p-4 text-left font-medium hover:bg-gray-50">
                <span>{t('faqPlatformsQuestion')}</span>
                <span>+</span>
              </CollapsibleTrigger>
              <CollapsibleContent className="p-4 pt-0 bg-gray-50 text-muted-foreground text-sm">
            ...
            <Collapsible className="border border-gray-200 rounded-md overflow-hidden">
              <CollapsibleTrigger className="flex justify-between w-full p-4 text-left font-medium hover:bg-gray-50">
                <span>{t('faqRecommendationsQuestion')}</span>
                <span>+</span>
              </CollapsibleTrigger>
              <CollapsibleContent className="p-4 pt-0 bg-gray-50 text-muted-foreground text-sm">
            ...
            <Collapsible className="border border-gray-200 rounded-md overflow-hidden">
              <CollapsibleTrigger className="flex justify-between w-full p-4 text-left font-medium hover:bg-gray-50">
                <span>{t('faqAutomaticQuestion')}</span>
                <span>+</span>
              </CollapsibleTrigger>
              <CollapsibleContent className="p-4 pt-0 bg-gray-50 text-muted-foreground text-sm">
                {t('faqAutomaticAnswer')}
              </CollapsibleContent>
            </Collapsible>
          </div>
        </div>
