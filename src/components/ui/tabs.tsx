...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-start rounded-lg bg-slate-100/80 p-1.5 text-muted-foreground font-cal gap-1",
      className
    )}
    {...props}
  />
